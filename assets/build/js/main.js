...
jQuery(document).ready(function () {
  ...
  jQuery(".review_slider").owlCarousel(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({
    items: 2,
    ...
    itemsTablet: [767, 2]
  }, "itemsTablet", [545, 1]), "itemsMobile", [360, 1]), "navigation", true), "navigationText", ["<a class=\"flex-prev\"></a>", "<a class=\"flex-next\"></a>"]), "slideSpeed", 500), "pagination", false));
});
}();
/******/ })()
;
